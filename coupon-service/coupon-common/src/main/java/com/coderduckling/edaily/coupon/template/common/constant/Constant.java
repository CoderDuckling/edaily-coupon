package com.coderduckling.edaily.coupon.template.common.constant;
...
public class Constant {
    ...
    /** Kafka 消息的 Topic */
    public static final String TOPIC = "edaily_user_coupon_op";
