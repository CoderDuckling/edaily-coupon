...
import com.coderduckling.edaily.coupon.common.vo.GoodsInfo;
...
import com.coderduckling.edaily.coupon.distribution.feign.TemplateClient;
import com.coderduckling.edaily.coupon.distribution.service.IRedisService;
import com.coderduckling.edaily.coupon.distribution.service.IUserService;
import com.coderduckling.edaily.coupon.distribution.vo.AcquireTemplateRequest;
import com.coderduckling.edaily.coupon.distribution.vo.CouponClassify;
...
/**
 * @ Description   :  所有的操作过程, 状态都保存在 Redis 中, 并通过 Kafka 把消息传递到 MySQL 中
 * @ Author        :  CoderDuckling
 * @ CreateDate    :  2020/5/3 22:28
 * @ Version       :  1.0
 */
